...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.ok_ac_policy'
        db.add_column('tutorial_course', 'ok_ac_policy',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.ok_ac_policy'
        db.delete_column('tutorial_course', 'ok_ac_policy')
