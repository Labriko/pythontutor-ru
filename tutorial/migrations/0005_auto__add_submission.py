...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tutorial_submission', (
        ...
        db.send_create_signal('tutorial', ['Submission'])

        # Adding index on 'Course', fields ['urlname']
        db.create_index('tutorial_course', ['urlname'])

        # Adding index on 'Problem', fields ['urlname']
        db.create_index('tutorial_problem', ['urlname'])

        # Adding index on 'Lesson', fields ['urlname']
        db.create_index('tutorial_lesson', ['urlname'])


    def backwards(self, orm):
        # Removing index on 'Lesson', fields ['urlname']
        db.delete_index('tutorial_lesson', ['urlname'])

        # Removing index on 'Problem', fields ['urlname']
        db.delete_index('tutorial_problem', ['urlname'])

        # Removing index on 'Course', fields ['urlname']
        db.delete_index('tutorial_course', ['urlname'])

        # Deleting model 'Submission'
        db.delete_table('tutorial_submission')
