...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.hidden'
        db.delete_column('tutorial_userprofile', 'hidden')

        # Adding field 'UserProfile.course'
        db.add_column('tutorial_userprofile', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tutorial.Course'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.hidden'
        db.add_column('tutorial_userprofile', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'UserProfile.course'
        db.delete_column('tutorial_userprofile', 'course_id')
